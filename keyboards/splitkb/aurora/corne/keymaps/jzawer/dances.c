...
static const tapdance tds[] PROGMEM ={
    ...
    { BASIC_TAP, XE(ES_I), XE(ES_J) },
    //BOX  code box, using Xeno approach
    { BASIC_TAP, XE(ES_G), XE(ES_H) },
